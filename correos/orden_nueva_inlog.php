...
$orden = $Clordenes->getOrden($id);  //VALIDAR ORDEN
if(!$orden){
    $return['success'] = 0;
...
$ClCourier = new cl_couriers();
$inlog = $ClCourier->getTokensInlog($orden['cod_sucursal']);
if(!$inlog){
    $return['success'] = 0;
    $return['mensaje'] = "Esta sucursal no esta asignada a inlog";
    header('Content-Type: application/json');
    echo json_encode($return);
    exit;
}

$idTracking = $inlog['idCliente'].str_pad($id, 8, "0", STR_PAD_LEFT);

$usuario = $Clusuarios->get($orden['cod_usuario']);
$detalles = $Clordenes->getOrdenDetalle($id);
$courier = $Clordenes->getCourier($id);
...
$asunto = "Solicitud de despacho de ".$name;

$numOrden = str_pad($orden['id'], 6, "0", STR_PAD_LEFT);
$estado = $orden['estado'];
...
require_once "./dompdf/htmlapdf.php";
$htmlPdf = getValues($usuario, $orden, $detalles, $courier, $idTracking);
//CREAR PDF
pdfCreate($htmlPdf, $nameFile = "orden".$numOrden.".pdf");
                 ...
                 <tr style="border-collapse:collapse"> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:540px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-bottom:5px"><h1 style="Margin:0;line-height:38px;mso-line-height-rule:exactly;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;font-size:32px;font-style:normal;font-weight:bold;color:#4A4A4A">Solicitud de envío</h1></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
                     ...
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px"> 
                        ...
                        <table width="100%">';
                          foreach ($detalles as $detalle) {
                              ...
                              $html .= '<tr>
                                    ...
                                    <td class="product-name" data-title="Product">
                                        ...
                                        <dl>
                                          <dt style="font-size: 12px;"><b>SKU</b></dt>
                                          <dd style="font-style: italic; font-size: 11px; margin: auto;">'.$detalle['sku'].'</dd>
                                        </dl>
                                    </td>
                          ...
                          <tr>
                            <td colspan="2"><p style="margin: 10px 0px 10px 0px;">Id para Tracking</p></td>
                            <td colspan="2" style="text-align: right;">'.$idTracking.'</td>
                          </tr>
                          <tr>
                            <td colspan="2"><p style="margin: 10px 0px 10px 0px;">Token Inlog</p></td>
                            <td colspan="2" style="text-align: right;">'.$courier['token'].'</td>
                          </tr>
                          <tr>
                            <td colspan="2"><p style="margin: 10px 0px 10px 0px;">Persona</p></td>
                            <td colspan="2" style="text-align: right;">'.$nombre.'</td>
                          </tr>
                          <tr>
                            <td colspan="2"><p style="margin: 10px 0px 10px 0px;">Telefono</p></td>
                            <td colspan="2" style="text-align: right;">'.$usuario['telefono'].'</td>
                          </tr>
                          <tr>
                            <td colspan="2"><p style="margin: 10px 0px 10px 0px;">Dirección</p></td>
                            <td colspan="2" style="text-align: right;">'.$direccion.'</td>
                          </tr>
...
if(isset($_GET['print'])){
  ...
  try {
      ...
      // $mail->addAddress("jbastidas@digitalmindtec.com", "INLOG");
      // $mail->addAddress("sebastian@digitalmindtec.com", "HB");
      $mail->addAddress("jgavilanes@inlog.com.ec", "Jgavilanes");
      $mail->addAddress("dsango@inlog.com.ec", "Dsango");
      // $mail->addAddress("jans-17@hotmail.com", "Jsantillan");
      // $mail->addAddress("josue.digitalmind@gmail.com", "JsantillanN");
      ...
      //ATTACHMENT
      $mail->AddAttachment($nameFile, 'orden.pdf');
...
function pdfCreate($html, $nameFile){
